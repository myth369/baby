 ...
 * @author  feimosi
 * @version 1.3.1
 * @url https://github.com/feimosi/previewImage.js
 */
...
var previewImage = (function() {
    ...
    var overlay, slider, previousButton, nextButton, closeButton, closeBar;
    ...
    function run(selector, userOptions) {
        ...
        [].forEach.call(
            ...
            function(galleryElement, galleryIndex) {
                ...
                var tags = galleryElement.getElementsByTagName('img');
    ...
    function buildOverlay() {
        overlay = getByID('previewImage-overlay');
        // Check if the overlay already exists
        if(overlay) {
            slider = getByID('previewImage-slider');
            previousButton = getByID('previous-button');
            nextButton = getByID('next-button');
            closeButton = getByID('close-button');
            closeBar = getByID('close-bar');
            return;
        }
        // Create overlay element
        overlay = create('div');
        overlay.id = 'previewImage-overlay';
        document.getElementsByTagName('body')[0].appendChild(overlay);
        // Create gallery slider element
        slider = create('div');
        slider.id = 'previewImage-slider';
        ...
        closeBar = create('div');
        closeBar.id = 'close-bar';
        closeBar.className = 'close-bar';
        closeBar.innerHTML = '<span id="return-btn" style="display:inline-block;padding:0 3%;">返回</span>';
        // overlay.appendChild(closeBar);

        previousButton.className = nextButton.className = closeButton.className = 'previewImage-button';
    ...
    function bindEvents() {
        ...
        bind(overlay, 'click', function(event) {
            if(event.target && event.target.nodeName !== 'IMG' && event.target.nodeName !== 'FIGCAPTION'){
                ...
                hideOverlay();
                // var display = closeBar.style.display;
                // if(display == 'none') {
        ...
        var returnBtn = getByID('return-btn');
        if(returnBtn) {
            bind(getByID('return-btn'), 'touchstart', function(event) {
                event.stopPropagation ? event.stopPropagation() : event.cancelBubble = true;
                hideOverlay();
            });
        }
    ...
    function getImageSrc(image) {
        ...
        var result = imageElement.getAttribute('data-viewsrc') || imageElement.src;
